      ...
      <Row justify={'center'}>
        <Col>
          <div
            ...
            <Card style={{ width: 320, textAlign: 'center' }} headStyle={{ fontSize: 13, fontWeight: 200 }} className={'shadow'} bordered={true} title={'Sign in to your account'}>
              <Form layout={'vertical'} name='normal_login' className='login-form' onFinish={onFinish}>
                <Form.Item label='Email' name='email' size={'large'} rules={[{ required: false, message: 'Please input your Username!' }]}>
