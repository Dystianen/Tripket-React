    ...
    <div className="tickets-container">
      ...
      >
        <Form form={form} name="search-train">
          <Form.Item label="Train" style={{ textAlign: "right" }}>
            <Input
              value="Kamandaka"
              disabled={false}
              prefix={<IoTrain />}
          ...
          <Form.Item label="Depart" style={{ textAlign: "right" }}>
            <Input
              value="Pekalongan"
              disabled={true}
              prefix={<IoArrowUpCircle />}
              style={{ width: "25rem" }}
            />
            <DatePicker
          ...
          <Form.Item label="Arrive" style={{ textAlign: "right" }}>
            <Input
              value="Asgard"
              disabled={true}
              prefix={<IoArrowDownCircle />}
              style={{ width: "25rem" }}
            />
